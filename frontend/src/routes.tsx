...
const UnifiedGeofences = lazy(() => import('./pages/UnifiedGeofences'));
const EmergencyModules = lazy(() => import('./pages/EmergencyModules'));
    ...
    return (
        <Routes>
            ...
            <Route element={<MainLayout />}>
                ...
                <Route path="/geofences-legacy" element={
                    <ProtectedRoute>
                        <Suspense fallback={<PageLoadingSpinner />}>
                            <GeofencesManager />
                        </Suspense>
                ...
                <Route path="/emergency-modules" element={
                    <ProtectedRoute>
                        <Suspense fallback={<PageLoadingSpinner />}>
                            <EmergencyModules />
                        </Suspense>
