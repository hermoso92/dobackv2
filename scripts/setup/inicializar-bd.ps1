# 🚀 SCRIPT DE INICIALIZACIÓN DOBACKSOFT
# Este script inicializa PostgreSQL con datos reales para producción

Write-Host "=========================================" -ForegroundColor Blue
Write-Host "  🚀 INICIALIZACIÓN DOBACKSOFT" -ForegroundColor Blue
Write-Host "=========================================" -ForegroundColor Blue
...
Write-Host "1. Ejecutar script de datos iniciales" -ForegroundColor White
