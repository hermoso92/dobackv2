...
@bp.route('/kpis/states', methods=['GET'])
@jwt_required()
def get_states_summary():
    """
    GET /api/v1/kpis/states?from=YYYY-MM-DD&to=YYYY-MM-DD&vehicleIds[]=X&vehicleIds[]=Y
...
@bp.route('/kpis/activity', methods=['GET'])
@jwt_required()
def get_activity_metrics():
    """
    GET /api/v1/kpis/activity?from=YYYY-MM-DD&to=YYYY-MM-DD&vehicleIds[]=X
...
@bp.route('/kpis/stability', methods=['GET'])
@jwt_required()
def get_stability_metrics():
    """
    GET /api/v1/kpis/stability?from=YYYY-MM-DD&to=YYYY-MM-DD&vehicleIds[]=X
...
@bp.route('/kpis/summary', methods=['GET'])
@jwt_required()
def get_complete_summary():
    """
    GET /api/v1/kpis/summary?from=YYYY-MM-DD&to=YYYY-MM-DD&vehicleIds[]=X
